  ...
  return (
    <div className="mt-6 mx-12">
      ...
      <div className=" flex flex-col justify-center items-center">
        <img width={600} height={600} src="/contents/about/certificate/cert1_alt.webp" alt={"/contents/about/certificate/cert1.jpg"} />
        <img width={565} height={600} src="/contents/about/certificate/cert2_alt.webp" alt={"/contents/about/certificate/cert2.jpg"} />
      </div>
    </div>
  );
}
